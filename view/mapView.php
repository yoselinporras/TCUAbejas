...
<div id="container">
    ...
    <div id="species-sidebar" class="species-sidebar collapsed">
            ...
            <li class="species-item">
                <a href="?controlador=Map2026&accion=mostrar#home" class="species-link">
                <i class="far fa-clock"></i>
                <span class="species-name">Ir al año 2026</span>
                </a>
            </li>
            ...
            <li class="species-item filtro-especie" id="todas2022" >
                ...
                <li class="species-item filtro-especie" id="especie1" >
                    ...
                    <span class="species-name">Abejas Solitarias</span>
                </li>
