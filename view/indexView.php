<?php
    ...
    $bannerTitle = "El ED-3514 y el TC-627 les dan la bienvenida";
    $bannerSubtitle = "Este sitio web contiene información sobre las abejas meliponas que hay en la Sede del Atlántico";
    $bannerSubtitle2= "¡Aprende sobre la importancia de las abejas de forma divertida!";
