...
<head>
    ...
    <link rel="stylesheet" href="/public/css/style-banner.css"> 
            ...
            <div class="container-header" id="encabezado"> 
                ...
                <a>
                    <img class="img-encabezado" src="./public/img/header/logoED.png" alt="Partes de abeja">
                                    ...
                                    <li class="nav-item">
                                        <a class="fa fa-map-marker nav-link" href="?controlador=Map2026&accion=mostrar">
                                            Mapa
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="fa fa-user-circle nav-link" href="?controlador=About&accion=mostrar">
                                            Creadores
                                        </a>
                                    </li>
                                            
                                    <li class="nav-item">
                                        <a class="fa fa-book nav-link" href="?controlador=PostComments&accion=mostrar">
                                            Acerca del proyecto
                                        </a>
                                    </li>
                                </ul>
...
<html lang="es">
    <head>
        ...
        <meta name="description"
            content="Sitio web de la Universidad de Costa Rica Sede del Atlántico que contiene información sobre las Abejas Meliponas y su ubicación en la sede">

        <link rel="icon" type="image/png" href="public/img/partesabeja.png">
    ...
    <body>
        <header>
            <div class="container-header" id="encabezado">
                ...
                <a>
                    <img class="img-encabezado" src="./public/img/header/logoED.png" alt="Logo ED">
                </a>
            </div>
            ...
            <nav id="navbar_top" class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav w-100 d-flex justify-content-around align-items-center">
                            <li class="nav-item">
                                <a class="nav-link" href="?controlador=Index&accion=mostrar">
                                    <i class="fa fa-home"></i> Inicio
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="?controlador=Map2026&accion=mostrar">
                                    <i class="fa fa-map-marker"></i> Mapa
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="?controlador=GeneralInformation&accion=mostrar">
                                    <i class="fa fa-info-circle"></i> Información
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="?controlador=Games&accion=mostrar">
                                    <i class="fa fa-gamepad"></i> Juegos
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="?controlador=About&accion=mostrar">
                                    <i class="fa fa-user-circle"></i> Creadores
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="?controlador=PostComments&accion=mostrar">
                                    <i class="fa fa-book"></i> Acerca del proyecto
                                </a>
                            </li>
                        </ul>
                    </div>
