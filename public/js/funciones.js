...
function activebuttons() {
    ...
    for (var i = 0; i < btns.length; i++) {
        btns[i].addEventListener("click", function () {
            ...
            current[0].className = current[0].className.replace(" activelistbutton", "");
...
function iniModalSidebar() {
    ...
    $("#modalespecie1").on('click', function () {
        ...
        $('#mymodal').modal('show');
        $('#img-ubicacion').attr("src", "public/img/ubicaciongeografica/Especies-1-3-7-8.png");
    ...
    $("#modalespecie4").on('click', function () {
        ...
        $('#morfologia').text("Esta especie presenta tonalidades de color naranja en el cuerpo, mientras que la mitad delantera de la cabeza y a los costados del tórax son de color amarillo. El tórax y la parte superior de la cabeza son de color café y finalmente las patas son de color negro. La longitud del cuerpo de un adulto puede llegar a medir entre 5-7 mm.");
        $('#comportamiento').text("La conducta de estas abejas es dócil y no defensivas, por lo que hay muy pocas abejas guardianas en la colmena.");
        $('#caracteristica').text("El nido presenta una estructura tubular sin porosidad. La forma del extremo de la colmena es irregular con forma ovalada. El tamaño se encuentra entre 1 cm de ancho y 15 cm de longitud.");
        ...
        $('#mymodal').modal('show');
        $('#img-ubicacion').attr("src", "public/img/ubicaciongeografica/Especies-4-5.png");
    ...
    $("#modalespecie5").on('click', function () {
        ...
        for (var i = 2; i < 29; i++) {
            $("#contenidocarousel").append('<div id="itemcarousel' + i + '" class="carousel-item"> <img id="img' + i + '" class="d-block w-100" alt="Colmena' + i + '"></div>');
            var name = '#img' + i;
    ...
    $("#modalespecie6").on('click', function () {
        ...
        $("#contenidocarousel").append('<div id="itemcarousel4" class="carousel-item"> <img id="img4" class="d-block w-100" alt="Colmena 4"></div>');
        $('#img4').attr("src", "public/img/chicopipe/chicopipe4.jpg");
        $("#contenidocarousel").append('<div id="itemcarousel5" class="carousel-item"> <img id="img5" class="d-block w-100" alt="Colmena 5"></div>');
        $('#img5').attr("src", "public/img/chicopipe/chicopipe5.jpg");
        $("#contenidocarousel").append('<div id="itemcarousel6" class="carousel-item"> <img id="img6" class="d-block w-100" alt="Colmena 6"></div>');
        $('#img6').attr("src", "public/img/chicopipe/chicopipe6.jpg");
        $("#contenidocarousel").append('<div id="itemcarousel7" class="carousel-item"> <img id="img7" class="d-block w-100" alt="Colmena 7"></div>');
        $('#img7').attr("src", "public/img/chicopipe/chicopipe7.jpg");

        $('#mymodal').modal('show');
        $('#img-ubicacion').attr("src", "public/img/ubicaciongeografica/Especies-6.png");
...
function popups() {
    ...
    especie3[1].on('mouseover', function (e) {
        this.bindPopup("Enreda pelo").openPopup();
    }).on('mouseout', function (e) {
        this.closePopup();
    });

    especie4[1].on('mouseover', function (e) {
        this.bindPopup("Mariolon").openPopup();
    }).on('mouseout', function (e) {
        this.closePopup();
    });


    especie8[1].on('mouseover', function (e) {
    ...
    for (var i = 1; i <= 23; i++) {
        especie5[i].on('mouseover', function (e) {
    ...
    for (var i = 1; i <= 5; i++) {
        especie6[i].on('mouseover', function (e) {
    ...
    for (var i = 1; i <= 5; i++) {
        especie7[i].on('mouseover', function (e) {
...
function alertsColmenas() {
    ...
    especie1[1].on('click', function (e) {
        ...
        $('#img1Colmena').attr("src", "public/img/abejassolitarias/abejassolitarias1.jpg");
        $('#img2Colmena').attr("src", "public/img/abejassolitarias/abejassolitarias2.jpg");
