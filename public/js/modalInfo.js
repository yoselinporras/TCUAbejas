...
const infoEspecies = {
  modalespecie1: {
    ...
    ubicacion: "public/img/ubicaciongeografica/Mapas Costa Rica Abejas Nativas_Abejas Orquideas y Soncuano.jpg",
    simbologia: "public/img/ubicaciongeografica/Simbologia.png",
    referencias: [1, 2],
    imagenes: [
  ...
  modalespecie4: {
    ...
    ubicacion: "public/img/ubicaciongeografica/Mapas Costa Rica Abejas Nativas_Mariola.webp",
    simbologia: "public/img/ubicaciongeografica/Simbologia.png",
    referencias: [6, 9],
    imagenes: [
  ...
  modalespecie6: {
    ...
    ubicacion: "public/img/ubicaciongeografica/Mapas Costa Rica Abejas Nativas_Chicopipe.webp",
    simbologia: "public/img/ubicaciongeografica/Simbologia.png",
    referencias: [6],
    imagenes: [
...
const referencias = {
  1: {
    referencia:
      "1. Anguebes, F; Pat, L; Pat, J; Hernández, P; Ramos, R. (2018). Condición y  perspectivas de la meliponicultura en comunidades mayas de la reserva de la biósfera Los Petenes, Campeche, México. Estudios de Cultura Maya LII: 227-254 (2018). Disponible en:",
    url: " http://www.scielo.org.mx/pdf/ecm/v52/0185-2574-ecm-52-227.pdf ",
  },
  2: {
    referencia:
      "2. Barquero, L; Stamatti, G. (2014). Cría y manejo de abejas sin aguijón. Ediciones del Subtrópico. Fundación ProYungas. Disponible en:",
  ...
  4: {
    referencia:
      "4. Parra, G. (2005). Abejas silvestres y polinización. Manejo Integrado de Plagas y Agroecología. Universidad Nacional de Colombia, Bogotá. Colombia. Pp: 7-20. Recuperado de:",
    url: "http://orton.catie.ac.cr/repdoc/A1865e/A1865e.pdf ",
  },
  5: {
    referencia:
      "5. Figueroa, G; Prendas, P. (2015). Sistema Automático de Clasificación de Abejas sin Aguijón (Apidae: Meliponini) Basado en el Contorno y Venación de sus alas. Instituto Tecnológico de Costa Rica. Recuperado de:",
    url: "https://repositoriotec.tec.ac.cr/bitstream/handle/2238/6448/informe-doc1-abejas.pdf",
  },
  6: {
    referencia:
      "6. Espinoza, F; Padilla, S; Hernández, P; Zamora, L. (2015). Guía práctica de identificación de abejas nativas sin aguijón (Apidae, Meliponini) por medio de sus entradas. Facultad de Ciencias de la Tierra y el Mar, Centro de Investigaciones Apícolas Tropicales. Universidad Nacional de Costa Rica.",
    url: "",
  },
  7: {
    referencia:
      "7. Zepeda, R; Arnold, N; Vásquez, M; Aldasoro, M. (2018). Las abejas sin aguijón y su cultivo en Oaxaca, México: con catálogo de especies. Comisión Nacional para el Conocimiento y Uso de la Biodiversidad. Pp: 117-121. Recuperado de:",
    url: "https://www.ecosur.mx/abejas/wp-content/uploads/sites/4/2018/06/Abejas-sin-aguijo%CC%81n-de-Oaxaca.pdf",
  },
  9: {
    referencia:
      "9. Figueroa, G; Prendas, J; Ramírez, M; Aguilar, I; Herrera, E; Travieso, G. (2015). Identificación de abejas sin aguijón (Apidae: Meliponini) a partir de la clasificación de los descriptores SIFT de una imagen del ala derecha anterior. Tecnología en Marcha. Edición especial. Pp: 51-63. Recuperado de:",
    url: "https://www.scielo.sa.cr/pdf/tem/v29s2/0379-3982-tem-29-s2-51.pdf",
  },
  10: {
    referencia:
      "10. Martínez, D. (2015). Estandarización de protocolo para la división de nidos de la especie Tetragonisca angustula y evaluación de su adaptación a diferentes diseños de colmenas en La Mesa (Cundinamarca). Universidad de Cundinamarca, Colombia. Recuperado de:",
  ...
  11: {
    referencia:
      "11. Vásquez, M. (2007). Recursos Polínicos Utilizados por la Abeja Nativa Shuruya (Scaptotrigona pectoralis) (Apidae: Meliponini) en un Meliponario de la parte baja de los Cipresales en Pachalum, Quiché, durante la época seca y lluviosa. Universidad de San Carlos de Guatemala. Recuperado de:",
    url: "https://biblioteca-farmacia.usac.edu.gt/tesis/B167.pdf",
  },
  12: {
    referencia:
      "12. Weng, Ju. (2005). Morfología comparativa de las tibias posteriores modificadas de los machos en cuatro géneros de abejas Euglosinas (Apinae: Euglossini) y biología de una larva polinívora, Allograpta micrura (Diptera: Syrphidae), en flores de Castilleja talamancensis (Schrophulariaceae). Universidad de Costa Rica. Recuperado de:",
    url: "http://repositorio.sibdi.ucr.ac.cr:8080/jspui/bitstream/123456789/4196/1/25713.pdf",
  },
  13: {
    referencia:
      "13. Parra, A. (2009). La arquitectura de nidos de Euglossa (Euglossa) hemichlora (Hymenoptera: Apidae: Euglossini). Revista Colombiana de Entomología 35(2): 283-285. Recuperado de:",
...
function abrirModalEspecie(modalKey) {
  ...
  // Texto
  document.getElementById("nombrecientifico").textContent =
  ...
  document.getElementById("referencias").innerHTML = referenciasDinamicas(
    data.referencias,
  );
  ...
  const imgSimbologia = document.getElementById("img-simbologia");
  imgSimbologia.src = data.simbologia;
